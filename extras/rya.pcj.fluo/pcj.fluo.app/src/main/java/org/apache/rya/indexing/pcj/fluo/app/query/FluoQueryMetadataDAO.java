...
/**
 * Reads and writes {@link FluoQuery} instances and their components to/from a
 * Fluo table.
 */
...
public class FluoQueryMetadataDAO {
     ...
     *            (not null)
     * @param metadata
     *            - The Query node metadata that will be written to the table.
     *            (not null)
     */
     ...
     *            null)
     * @param nodeId
     *            - The nodeId of the Query node that will be read. (not nul)
    ...
    private QueryMetadata.Builder readQueryMetadataBuilder(final SnapshotBase sx, final String nodeId) {
        ...
        final Map<Column, String> values = sx.gets(rowId, FluoQueryColumns.QUERY_VARIABLE_ORDER, FluoQueryColumns.QUERY_SPARQL,
        ...
        return QueryMetadata.builder(nodeId).setVariableOrder(varOrder).setSparql(sparql).setChildNodeId(childNodeId);
    }
     ...
     *            (not null)
     * @param metadata
     *            - The Filter node metadata that will be written to the table.
     *            (not null)
     */
     ...
     *            null)
     * @param nodeId
     *            - The nodeId of the Filter node that will be read. (not nul)
    ...
    private FilterMetadata.Builder readFilterMetadataBuilder(final SnapshotBase sx, final String nodeId) {
        ...
        // Fetch the values from the Fluo table.
        final String rowId = nodeId;
        final Map<Column, String> values = sx.gets(rowId, FluoQueryColumns.FILTER_VARIABLE_ORDER, FluoQueryColumns.FILTER_ORIGINAL_SPARQL,
                FluoQueryColumns.FILTER_INDEX_WITHIN_SPARQL, FluoQueryColumns.FILTER_PARENT_NODE_ID, FluoQueryColumns.FILTER_CHILD_NODE_ID);
     ...
     *            (not null)
     * @param metadata
     *            - The Join node metadata that will be written to the table.
     *            (not null)
     */
     ...
     *            null)
     * @param nodeId
     *            - The nodeId of the Join node that will be read. (not nul)
    ...
    private JoinMetadata.Builder readJoinMetadataBuilder(final SnapshotBase sx, final String nodeId) {
        ...
        // Fetch the values from the Fluo table.
        final String rowId = nodeId;
        final Map<Column, String> values = sx.gets(rowId, FluoQueryColumns.JOIN_VARIABLE_ORDER, FluoQueryColumns.JOIN_TYPE,
                FluoQueryColumns.JOIN_PARENT_NODE_ID, FluoQueryColumns.JOIN_LEFT_CHILD_NODE_ID, FluoQueryColumns.JOIN_RIGHT_CHILD_NODE_ID);
        ...
        return JoinMetadata.builder(nodeId).setVariableOrder(varOrder).setJoinType(joinType).setParentNodeId(parentNodeId)
                .setLeftChildNodeId(leftChildNodeId).setRightChildNodeId(rightChildNodeId);
    }
     ...
     *            (not null)
     * @param metadata
     *            - The Statement Pattern node metadata that will be written to
     *            the table. (not null)
     */
     ...
     *            null)
     * @param nodeId
     *            - The nodeId of the Statement Pattern node that will be read.
     *            (not nul)
     * @return The {@link StatementPatternMetadata} that was read from the
     *         table.
     */
     ...
     *            (not null)
     * @param metadata
     *            - The Aggregation node metadata that will be written to the
     *            table. (not null)
     */
     ...
     *            null)
     * @param nodeId
     *            - The nodeId of the Aggregation node that will be read. (not
     *            null)
    ...
    private AggregationMetadata.Builder readAggregationMetadataBuilder(final SnapshotBase sx, final String nodeId) {
        ...
        final AggregationMetadata.Builder builder = AggregationMetadata.builder(nodeId).setVariableOrder(varOrder)
     ...
     *            (not null)
     * @param query
     *            - The query metadata that will be written to the table. (not
     *            null)
     */
     ...
     *
     * @param sx
     *            - The snapshot that will be used to read the metadata from the
     *            Fluo table. (not null)
     * @param queryId
     *            - The ID of the query whose nodes will be read. (not null)
