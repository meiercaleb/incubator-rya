...
public class PeriodicQueryUtilTest {
    ...
    public void periodicNodePresentTest() throws Exception {
        ...
        PeriodicQueryNode node2 = new PeriodicQueryNode(12*60*60*1000L, 6*3600*1000L, TimeUnit.HOURS, "time", new Join());
    ...
    public void periodicNodeFractionalDurationTest() throws Exception {
        ...
        PeriodicQueryNode node2 = new PeriodicQueryNode((long) window, (long) period, TimeUnit.HOURS, "time", new Join());
